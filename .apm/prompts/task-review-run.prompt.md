---
description: Run the full task-review workflow by chaining context, findings, and fix prompts through artifact paths.
input: [scope]
---
...
- in that subagent, run `/task-review-context ${input:scope}`
