---
description: Gather scoped task-review context and record matching guidance examples in a repeatable artifact.
input: [scope]
---
...
Input mode:
- `${input:scope}` is a review scope, not an artifact path, for this command
